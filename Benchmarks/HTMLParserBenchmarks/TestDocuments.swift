...
enum TestDocuments {
    ...
    // MARK: - XML-adapted versions for BonMot (XMLParser-compatible)

    /// Small XML document — same content as small, adapted for XMLParser
    static let smallXML = """
    <root>
        <h3>MacBook Pro 14"</h3>
        <p><b>$1,999</b> <s>$2,499</s></p>
        <p>Apple M3 Pro chip, 18GB RAM, 512GB SSD.</p>
        <ul>
            <li>Up to 17 hours battery life</li>
            <li>Liquid Retina XDR display</li>
    ...
    /// Medium XML document — same content as medium, adapted for XMLParser
    static let mediumXML: String = {
        return """
        <root>
            <h1>Getting Started with Swift Concurrency</h1>
            <p>Published on March 15, 2025 by <a>Jane Smith</a></p>
            ...
            <h2>Key Concepts</h2>
            <ol>
                <li><strong>async/await</strong> &#8212; Mark functions as async and call them with await</li>
                <li><strong>Task</strong> &#8212; Create a unit of asynchronous work</li>
                <li><strong>Actor</strong> &#8212; Protect mutable state from data races</li>
                <li><strong>Sendable</strong> &#8212; Types safe to pass across concurrency domains</li>
                <li><strong>AsyncSequence</strong> &#8212; Iterate over values delivered asynchronously</li>
            </ol>
            ...
            <ul>
                <li>Use <code>try await</code> for throwing async functions</li>
                <li>Task cancellation is cooperative &#8212; check <code>Task.isCancelled</code></li>
                <li><code>withTaskCancellationHandler</code> for cleanup</li>
            </ul>
            ...
            <p>Further reading:</p>
            <ul>
                <li><a>Official Swift Concurrency Guide</a></li>
                <li><a>WWDC Sessions on Concurrency</a></li>
                <li><a>Swift Evolution Proposals</a></li>
            </ul>
        </root>
        """
    }()

    /// Large XML document — same content as large, adapted for XMLParser
    static let largeXML: String = {
        ...
        for (i, (title, subtitle)) in sectionTopics.enumerated() {
            ...
            <section>
                ...
                <div>
                    <p><strong>Note:</strong> Before proceeding, ensure you have completed the
                    <a>Installation</a> steps and have a working development environment.</p>
                </div>
            ...
            assert(\(title.replacingOccurrences(of: " ", with: ""))Manager.shared.isReady)</code></pre>
                ...
                <ul>
                    ...
                    <li>Handle errors with <code>do/catch</code> blocks and provide user feedback</li>
                    <li>Cache results when appropriate to reduce network calls</li>
                    <li>Follow the <a>Security</a> guidelines for sensitive data</li>
                    <li>Write tests for all critical paths (see <a>Testing</a>)</li>
                </ul>
        ...
        <root>
            <header>
                ...
                <nav>
                    <ul>
                        \(sectionTopics.enumerated().map { "<li><a>\($0.element.0)</a></li>" }.joined(separator: "\n                        "))
                    </ul>
                </nav>
            </header>
            <main>
            ...
            <footer>
                <p>&#169; 2025 Framework Team. All rights reserved.</p>
                <p>Licensed under <a>MIT License</a>.</p>
            </footer>
        </root>
        """
    }()
